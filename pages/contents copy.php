...
$stmt = $pdo->prepare("
    SELECT u.username, ws.score, ws.points, ws.time_played
    FROM whack_scores ws
    JOIN users u ON ws.user_id = u.id
    ORDER BY ws.time_played DESC
    LIMIT 1
                ...
                <div id="sub-tab1" class="sub-tab-content active">
                    <div class="leaderboard whack-leaderboard">
                        ...
                        <section class="leaderboard-data">
                            <h3>High Score | <span class="game-name">Whack</span></h3>
                        ...
                        <section class="leaderboard-data">
                            <h3>Highest Total Points | <span class="game-name">Whack</span></h3>
                        ...
                        <section class="leaderboard-data">
                            <h3>Highest Time Played | <span class="game-name">Whack</span></h3>
