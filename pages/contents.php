    ...
    <main>
                        ...
                        <div class="top-players-grid">
                            <?php if ($whack_top_score): ?>
                                <div class="top-card score-leader">
                                    ...
                                    <span class="value"><?= number_format($whack_top_score['score']) ?></span>
                                </div>
                            <?php else: ?>
                            ...
                            <?php if ($whack_top_points): ?>
                                <div class="top-card points-leader">
                                    ...
                                    <span class="value"><?= number_format($whack_top_points['total_points']) ?></span>
                                </div>
                            <?php else: ?>
                                <div class="top-card empty">
                ...
                <div id="sub-tab2" class="sub-tab-content">
                    <div class="leaderboard">
                        <div class="top-players-grid">
                            <?php if ($click_top && $click_top['top_clicks_user']): ?>
                                <div class="top-card clicks-leader">
                                    ...
                                    <span class="value"><?= number_format($click_top['top_clicks']) ?></span>
                                </div>
                                ...
                                <div class="top-card coins-leader">
                                    ...
                                    <span class="value"><?= number_format($click_top['top_coins']) ?></span>
                                </div>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><?= number_format($user['total_clicks']) ?></td>
                                                </tr>
                                            <?php endforeach; ?>
                                        </tbody>
                                    </table>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><?= number_format($user['total_coins']) ?></td>
                                                </tr>
                                            <?php endforeach; ?>
                                        </tbody>
                                    </table>
                        ...
                        <div class="dev-notice">
                            ...
                            <span class="dev-sub">Leaderboard for Click Adventure is currently in progress. Check back soon!</span>
                        </div>
                    </div>
            </section>
        </div>
        ...
        <div id="tab2" class="tab-content">
            <section class="leaderboard-section">
                <div class="leaderboard">
                                    ...
                                    <tbody>
                                        <?php foreach ($users as $user): ?>
                                            <tr>
                                                ...
                                                <td class="user-bio"><?= !empty($user['bio']) ? htmlspecialchars($user['bio']) : '—' ?></td>
                                                <?php
                    ...
                    <div class="dev-notice">
                        <span class="dev-icon">🚧</span>
                        <span class="dev-text">New Update</span>
                        <span class="dev-sub">Added Bio column and hover bio when overflow.</span>
                    </div>
                </div>
            </section>
        </div>
        ...
        <div id="tab3" class="tab-content">
            <section class="updates-container">
                ...
                <span class="dev-icon">🚧</span>
                <span class="dev-text">Under Development</span>
                <span class="dev-sub">Updates Tab is currently in progress. Check back soon!</span>
            </div>
            </section>
