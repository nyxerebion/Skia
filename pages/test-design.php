<?php
// /test-design/email-preview.php

$title = "Reset Your Password";
$resetLink = "https://skia.unaux.com/reset-password.php?token=test123";
$username = "JohnDoe";
...
<body>
    ...
    <div class='container'>
        <div class='header'>
            <a href='https://skia.unaux.com' class='logo'>Skia<span>.</span></a>
        </div>
        <div class='content'>
            <?= $content ?>
        </div>
        <hr class='divider'>
        <div class='footer'>
            <p>Skia &bull; Built with ❤️ by Axel</p>
