...
$PHPMAILER_LANG['instantiate']          = 'Nedá sa vytvoriť inštancia SMTPovej funkcie.';
$PHPMAILER_LANG['invalid_address']      = 'Neodoslané, SMTPová adresa je nesprávna: ';
$PHPMAILER_LANG['invalid_hostentry']    = 'Záznam hostiteľa je nesprávny: ';
$PHPMAILER_LANG['invalid_host']         = 'Hostiteľ je nesprávny: ';
$PHPMAILER_LANG['mailer_not_supported'] = ' SMTPový klient nieje podporovaný.';
$PHPMAILER_LANG['provide_address']      = 'Musíte zadať aspoň jednu SMTPovú adresu príjemcu.';
