...
$clickOnlineUsers = getOnlineUsersCount('click');
?>
        ...
        <section class="game-grid">
            <div class="game-card">
                <div class="game-header">
                    ...
                    <div class="game-meta">
                        <span class="players">👥 <span id="whack-players">0</span> online</span>
            ...
            <div class="game-card coming-soon">
                ...
                <div class="game-meta">
                    <span class="status offline">🔴 Coming Soon</span>
            ...
            <div class="game-card">
                ...
                <p>Click almighty. Under Development!</p>
                <div class="game-meta">
